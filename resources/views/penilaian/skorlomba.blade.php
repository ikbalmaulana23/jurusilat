        ...
        <div class="border">
            ...
            <div class="flex justify-center">
                ...
                <div class="grid grid-cols-2 gap-7 mt-10">
                    ...
                    <div class="border border-black p-3 rounded-md">
                        <input type="text" style="border: none"  class="w-full" name="orisinil">
                    </div>
                    ...
                    <div class="border border-black p-3 rounded-md">
                        <input type="text" style="border: none" class="w-full" name="kekayaan_teknik">
                    </div>
                    <div class="border border-black p-3 rounded-md">
                        <p class="font-semibold">Kekayaan Gerakan</p>
                    </div>
                    <div class="border border-black p-3 rounded-md">
                        <input type="text" style="border: none" class="w-full" name="kemantapan_gerak">
                    </div>
                    <div class="border border-black p-3 rounded-md">
                        <p class="font-semibold">Penampilan </p>
                    </div>
                    <div class="border border-black p-3 rounded-md">
                        <input type="text" style="border: none" class="w-full" name="penampilan">
                    </div>
                    <div>
