<x-layout>
    <main class="">
      <div class="flex gap-2">
        ...
        <a href="/skorceritera" class="px-3 py-1 rounded-t-md bg-yellow-400">Ceritera</a>
      </div>
      <div class="container md:mx-auto mb-5 border pt-10">
  
     
        
        <a href="/formceritera" class="px-6 py-3.5 text-base font-medium text-white bg-blue-600 hozver:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-center dark:bg-blue-500 dark:hover:bg-blue-600 dark:focus:ring-blue-800">Mulai Penilaian Ceritera</a>
