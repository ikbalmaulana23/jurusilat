        ...
        <div class="max-w-6xl mx-auto">
          <div class="bg-white p-3 mb-5">
            ...
            <div class="flex gap-2">
              <a href="/rekapnilai" class="px-3 py-1 rounded-t-md hover:bg-blue-300 border">Tunggal</a>
              <a href="/rekapnilai/pasangan" class="px-3 py-1 rounded-t-md border  bg-yellow-400">Pasangan</a>
