        ...
        <div class="max-w-6xl mx-auto">
          <div class="bg-white p-3 mb-5">
            ...
            <div class="flex gap-2">
              ...
              <a href="/juri/ceritera" class="px-3 py-1 rounded-t-md border bg-yellow-400 ">Ceritera</a>
            </div>
            <div class="container md:mx-auto mb-5 ">      
              ...
              <div class=" m-5 py-5 grid grid-cols-4 gap-3">
                ...
                @foreach ($detail_peserta_ceritera as $ceritera )

                <div class=" p-5 border rounded-md shadow-md  ">
                  <p>Nama Peserta : <span class="font-semibold">{{ $ceritera->nama}}</span> </p>
                  <p>Golongan : {{ $ceritera->golongan}} </p>
                  <p class="mb-3">Kontingen : {{ $ceritera->kontingen}} </p>

                  <div class="flex justify-center">
                    <a href="/skorlomba/{{$ceritera->id}}" class=" my-2 px-2 py-1 bg-green-700 text-white rounded-md">Nilai Peserta ini</a>
                  </div>
