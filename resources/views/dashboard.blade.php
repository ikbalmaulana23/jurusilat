...
<div>
    <h1 class="text-xl font-semibold text-center mb-10">Selamat Datang Pada Website Sistem Digital Score Silat di Sumatera Barat</h1>
    ...
    <div class="flex justify-center my-7 text-white">
        <a href="/pendaftaran" class="bg-red-600 px-3 py-2 rounded-md hover:bg-red-800">Daftarkan diri Anda Sekarang</a>
    </div>
